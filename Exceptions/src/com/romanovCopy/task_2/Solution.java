...
//    }
    ...
    // 3 В блоке catch необходимо указать тип исключения, которое мы хотим перехватить.
    //   В данном случае, указан тип ArithmeticException, что позволит перехватить
    //  исключение, возникающее при делении на ноль.
    // 4 Выводимое сообщение в блоке catch может быть более информативным,
